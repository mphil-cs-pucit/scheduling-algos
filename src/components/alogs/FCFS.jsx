...
function FCFS({ processData, setFinalResult, finalResult, unitTime }) {
    ...
    return (
        <div>
            ...
            <FCFSTimeline readyQ={readyQ} setReadyQ={setReadyQ} setFinalResult={setFinalResult} finalResult={finalResult} unitTime={unitTime} />
        </div>
    )
}
